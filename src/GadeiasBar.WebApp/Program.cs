using GadeiasBar.Aplicacao;
using GadeiasBar.Infra;
using GadeiasBar.Infra.Compartilhado.Orm;
using GadeiasBar.WebApp.Compartilhado;
...
builder.Services.AddHealthChecks()
    .AddDbContextCheck<GadeiasBarDbContext>(
        name: "database_check",
...
if (app.Environment.IsDevelopment())
{
    ...
    var dbContext = scope.ServiceProvider.GetRequiredService<GadeiasBarDbContext>();
