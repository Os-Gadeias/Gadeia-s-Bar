...
namespace GadeiasBar.Testes.E2E.Compartilhado;
...
public sealed class TestApplicationFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            services.RemoveAll<DbContextOptions<GadeiasBarDbContext>>();
            services.RemoveAll<IDbContextOptionsConfiguration<GadeiasBarDbContext>>();
